    ...
    return (
        <div>
                                        ...
                                        <div className="row justify-content-center">
                                            <div className="col-12 text-center">
                                                ...
                                                >
                                                    ...
                                                    elit. Deserunt asperiores
                                                    cupiditate doloremque iusto
                                                    explicabo, quia minus
                                                    mollitia ratione nobis
                                                    sapiente commodi ea?
                                                    Corrupti molestias porro
                                                    explicabo facilis dolorum
                                                    officiis quisquam!
                                                </p>
                                ...
                                <div className="col-12 col-md-8">
                                    <div className="row justify-content-center">
                                        ...
                                        <p style={{ textAlign: "justify" }}>
                                            ...
                                            Deserunt asperiores cupiditate
                                            doloremque iusto explicabo, quia
                                            minus mollitia ratione nobis
                                            sapiente commodi ea? Corrupti
                                            molestias porro explicabo facilis
                ...
                <div className="row gy-3 text-white text-center">
                    ...
                    <div className="col-md-12">
                        <p>
                            ...
                            elit. Perferendis excepturi, blanditiis optio
                            repudiandae, dolor obcaecati, voluptatem et fuga
                            vitae suscipit minus facere quasi consectetur
                            sapiente delectus eum amet ducimus doloribus.
                        </p>
                    </div>
                    <div>
                        <button
            ...
            <div id="faq" className="container mb-5">
                <div className="row">
                    <div className="col-lg-6 col-12 mb-4 mb-lg-0 text-lg-start text-center">
