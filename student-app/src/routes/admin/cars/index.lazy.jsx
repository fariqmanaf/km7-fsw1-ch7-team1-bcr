          ...
          <Col className="d-flex flex-row px-5 mb-4 gap-2">
            <Button
              ...
              style={{
                transition: "all 0.3s",
                backgroundColor:
                  selectedTransmission === "all" ? "#0d6efd" : "transparent",
                color: selectedTransmission === "all" ? "#FFFFFF" : "#0d6efd",
              }}
            >
              All
            </Button>
            <Button
              ...
              style={{
                transition: "all 0.3s",
                backgroundColor:
                  selectedTransmission === "Manual" ? "#0d6efd" : "transparent",
                color:
                  selectedTransmission === "Manual" ? "#FFFFFF" : "#0d6efd",
              }}
            >
              Manual
            </Button>
              ...
              style={{
                ...
                backgroundColor:
                  selectedTransmission === "Automatic"
                    ...
                    : "transparent",
                color:
                  selectedTransmission === "Automatic" ? "#FFFFFF" : "#0d6efd",
              }}
            >
              Automatic
            </Button>
                      ...
                      <Card>
                        ...
                        >
                          ...
                          <Card.Text className="fw-bold w-100">
                            {car?.manufactures?.name} {car?.models?.model}{" "}
                            {car?.availability?.available === true ? (
                          ...
                          <Card.Text>
                            <span className="fw-semibold">
                              Rp. {car.availability?.rent_perday} / hari
                            </span>
                          </Card.Text>
                          <Card.Text>
                            Transmission :{" "}
                            <span className="fw-semibold">
                              {car?.car_details[0]?.transmission}
                            </span>
                          </Card.Text>
                          <Card.Text>
                            <span>Capacity: {"  "}</span>
                            <span className="fw-semibold">
                              {car.car_details[0]?.capacity} Person
                            </span>
                          </Card.Text>
