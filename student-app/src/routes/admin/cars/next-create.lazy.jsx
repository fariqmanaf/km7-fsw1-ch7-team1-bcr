...
function NextCreateComponent() {
  ...
  const carDetailsState = useSelector((state) => state.car_details.carDetails)
  ...
  const [imageURL, setImageURL] = useState(carDetailsState?.url_image || null)
  ...
  if (!token) {
    return (
      ...
      >
        <Col>
          <h4 className="text-center">Please login first to get cars data!</h4>
        </Col>
      </Row>
    )
  }
  ...
  const onClickForm = () => {
    if (carDetailsState === null) {
      return toast.error('Your Progress Has Been Lost, Please Start Again!')
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="w-75 text-center mt-1" style={{ fontSize: '0.8rem' }}>
          ...
          <Form.Group controlId="availability" className="d-flex gap-2">
            <div style={{ width: '50%' }}>
              ...
              <Form.Control
                ...
                defaultValue={modelsState === null ? '' : modelsState.model}
                onChange={(event) =>
                  dispatch(
                    setModelsState({
                      ...modelsState,
            ...
            <div style={{ width: '50%' }}>
              ...
              <Form.Control
                ...
                defaultValue={modelsState === null ? '' : modelsState.type}
                onChange={(event) =>
                  dispatch(
                    setModelsState({
                      ...modelsState,
